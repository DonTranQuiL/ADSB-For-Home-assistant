...
class AirplanesLiveCoordinator(DataUpdateCoordinator):
    def __init__(self, hass: HomeAssistant, config_entry):
        ...
        self.api = AirplanesLiveAPI(async_get_clientsession(hass), hass)
        ...
        state_obj = hass.states.get("sensor.airplanes_live_tracker_additional_tracked")
        if state_obj:
    ...
    def add_track(self, identifier):
        if identifier:
            ...
            _LOGGER.info("Airplanes.Live: Target '%s' added to tracking list.", clean_id)
