...
> We have just released a gigantic core rewrite! This integration (formerly adsb.fi open data Tracker) now features a **Hybrid Engine**, combining the ultra-fast adsb.fi open data radar feed with rich **FlightRadar24 API enrichment** (live routes, high-res photos, and scheduled times). Welcome to the SkyRadar Fusion era!
...
It was not possible without the ADS-B data from api.adsb.fi open data 
